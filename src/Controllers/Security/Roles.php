...
class Roles extends PrivateController
{
    ...
    {
        $this->partialName =
            Context::getContextByKey("roles_partialName");


        $this->status =
            Context::getContextByKey("roles_status");


        $this->orderBy =
            Context::getContextByKey("roles_orderBy");


        $this->orderDescending =
            boolval(
                Context::getContextByKey(
                    "roles_orderDescending"
                )
            );
